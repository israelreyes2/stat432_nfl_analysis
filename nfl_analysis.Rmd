...
```{r calculating rmse function}
calc_rmse = function(actual, predicted){
  sqrt(mean((actual - predicted)^2))
}
```

```{r linear modeling and stepwise, cache= TRUE}
...
```{r}
results = tibble(
  Modrl = c("Linear", "Ridge", "Lasso", "GBM"),
