...
NFL is one of the most-loved professional sport league in the United States. NFL is undoublty the top sport league in the United States bringing in over $13 billion in revenue each year. With that, each and every player on a team is under tremdouble pressure to performe under the spot light. Let's look at the other important piece of NFL games, the coaches. Some say that football is a chess game, which head coaches are the players of the game, and NFL players are peices which head coaches move to win the game. With that, every head coach's goals to call plays which will give them any sort of edge over their oppoenent. American football is quite differnt from other sports since after each play, game stops. After each play, coaches tell their players to run a play which will allow them to score. Head coaches call plays based on combination of experiences, time on clock, field positions, their team's best players, and more. What if, like other sports, analytics can call plays? 
...
The NFL data for each season contains 257 different variables in attempt to explain every play of the game in every game of the season. Each and every play of the game is broken down into great detail containing information on game situation, players involed, resutls, and advanced football analytical metrics. Here are few variables correlating to these.

 - Game situation : _Posteam_, _Defteam_,  _Game_date_
 - Players Invovled : _passer_player_name_, _receiver_player_name_, _rusher_player_name_, _punter_player_name_, _kicker_player_name_
 - results : _yrd_gained_
 - advanced analytics : _wpa_

To futher explain WPA, WPA stands for win probability added. The difference between the team's win probability at the beginning of the play and at the end of the play. WPA measures each play's impact on the outcome of a game. WPA takes incounter of players who were directly involved in the play. For offensive team, players who ran, threw, kicker, recieved, or flagged for penalty and for defensive team, players who tacked, sacked the ball carrier, caused a fumble, defended a passs, or flagged for penalty are considered. For purpose of our study, we will only focus on the offensive plays of a team. 
...
3. In NFL there are 10 types of play a team can excute throughout the game. However, for our purpose of the study, we will remove following play types for following reasons: 
 ...
 - kickoff : In NFL games, there are two kickoffs that always happens, once in the beginning of the 1st quarter and once more in the beginning of 3rd quater. However, wpa is not calculated when the inital kickoff in the 1st quater happens, so these will be ignored. However, any other times that kickoff occrs, wpa is valid. 
