...
```{r variable type trasformation}
df_2018_cleaned$posteam = as.factor(df_2018_cleaned$posteam)
df_2018_cleaned$defteam = as.factor(df_2018_cleaned$defteam)

df_2018_cleaned$play_type = as.factor(df_2018_cleaned$play_type)

df_2018_cleaned$passer_player_name = as.factor(df_2018_cleaned$passer_player_name)
df_2018_cleaned$receiver_player_name = as.factor(df_2018_cleaned$receiver_player_name)
df_2018_cleaned$rusher_player_name = as.factor(df_2018_cleaned$rusher_player_name)
df_2018_cleaned$punter_player_name = as.factor(df_2018_cleaned$punter_player_name)
df_2018_cleaned$kicker_player_name = as.factor(df_2018_cleaned$kicker_player_name)
```
